...
function RecentWeatherHistory() {
    ...
    return (
        <div className="w-full px-2 border-r dark:border-gray-700 border-gray-400">
            <div className="flex justify-between items-center bg-slate-100 dark:bg-darkBg bg-transparent px-3 rounded text-white text-xl font-semibold py-2 mb-4">
                <h3 className="dark:text-white text-black text-white`">Recent Search Location </h3>
                {/* <FaCloud /> */}
            </div>
